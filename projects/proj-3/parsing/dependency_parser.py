...
class DependencyParser():
    ...
    def evalInstances(self,instances,weight_update = None):
        ...
        for instance in instances:
            ...
            n_instances += 1
        print "Accuracy: {0}={1}/{2}".format(np.double(n_tokens - n_mistakes)/np.double(n_tokens),n_tokens-n_mistakes,n_tokens)
    ...
    def train_perceptron(self, n_epochs):
        ...
        for epoch in range(n_epochs):
            ...
            print "Train",
            self.evalInstances(self.reader.train_instances,self.perceptron_update)
            total += self.weights   
            print "Devel",
            ...
            self.evalInstances(self.reader.test_instances)
